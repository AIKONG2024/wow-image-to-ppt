...
The checked-in example was generated from the current local runtime. In that run PaddleOCR was active and SAM3 was not active, so visual segmentation used OpenCV fallback. Enable SAM3 for better semantic image/icon separation.
...
- Text becomes editable PPT text.
